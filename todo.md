...
- [ ] Убрать искусственную перспективу, из-за которой интерфейс выглядит криво.
- [ ] Сохранить корректное соотношение сторон, crop и readable UI preview.
- [ ] Проверить карточку Talio на desktop и mobile после исправления.

## Thesis section layout fix

- [ ] Исправить узкую desktop-колонку, из-за которой заголовок переносится по одному слову.
- [ ] Убрать выход заголовка за нижнюю границу секции и пустой дисбаланс справа.
- [ ] Проверить thesis на desktop и mobile после исправления.

## Logo reference development

- [ ] Воспроизвести широкую арочную M с мягкими скруглениями и плавным blue-violet gradient.
- [ ] Сохранить отдельную lime-точку над правой аркой и белый wordmark maybei.
- [ ] Сохранить разреженный слоган MAKE IT BETTER. под wordmark.
- [ ] Подготовить чистый lockup без курсора, лишнего фона и искажений.
